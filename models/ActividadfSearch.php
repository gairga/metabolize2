...
/**
 * ActividadfSearch represents the model behind the search form about `app\models\Actividadf`.
 */
class ActividadfSearch extends Actividadf
{
    /**
     * @inheritdoc
     */
