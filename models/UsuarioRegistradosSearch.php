...
/**
 * UsuarioRegistradosSearch represents the model behind the search form about `app\models\UsuarioRegistrados`.
 */
class UsuarioRegistradosSearch extends UsuarioRegistrados
{
    /**
     * @inheritdoc
     */
